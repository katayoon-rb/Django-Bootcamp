...
from .views import HomeView, trip_list, NoteListView, NoteCreateView, TripCreateView, TripDetailView, TripUpdateView, TripDeleteView, NoteDetailView, NoteUpdateView, NoteDeleteview
